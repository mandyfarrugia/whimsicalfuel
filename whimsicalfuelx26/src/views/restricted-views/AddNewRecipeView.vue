<!-- <script setup>
    ...
    const validationRules = computed(() => ({
        ...
        mealTypes: {
            required: helpers.withMessage('At least one meal type is required!', required)
        },
        mealPeriods: {
    ...
    const validationErrors = computed(() => ({
        ...
        mealTypes: !v$.value.mealTypes.$dirty
            ? []
            : v$.value.mealTypes.$errors.map((error) => error.$message),
